/*
   IOT012 - Atividade Final - Alternativa 02

   Gabriel de Oliveira Linma
...
void serverOnPost(AsyncWebServerRequest* request)
{
    ...
    request->send(200, "text/plain", "Finalizado - o ESP32 vai reiniciar e se conectar ao AP definido.");
